...
export default function Gallery() {
  ...
  <div className="mx-auto mt-16 grid max-w-2xl grid-cols-2 gap-x-8 gap-y-12 lg:mx-0 lg:max-w-none lg:grid-cols-3">
    {gallery.map((item) => (
      <div key={item.id} className="group relative">
        <div className="relative h-40 lg:h-80 w-full overflow-hidden rounded-2xl bg-gray-100">
          <img
            src={item.image}
            alt={item.title}
